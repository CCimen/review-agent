...
from .review_source_initialization import (
    ...
    initialize_review,
    load_changed_files as load_changed_files,
)
...
def review_begin(args: dict[str, Any], **context: Any) -> str:
    ...
    try:
        ...
        initialized = initialize_review(
            source,
            postgres_runtime(),
            installed_review_contract(),
            pull_identity=(repository, number, pull),
        )
        subject = initialized.subject
        pull = initialized.pull
        file_index = initialized.file_index
        ...
        result = overview_payload(
            ...
            changed_files_reported=initialized.changed_files_reported,
        )
        result.update(
            {
                "run_id": run_id,
                ...
                "started_at": initialized.started_at,
                "continued": True,
            }
        )
